...
public sealed class DataResourceManager
{
	...
	public DataResourceManager()
	{
		...
		RulesResource.OnSaveChangesSignal += () => { };
		UserDataInfoResource.OnSaveChangesSignal += () => { };
	}
	...
	//{
	//    SaveResource(UserDataInfoResourceOriginal, _userDataFilePath);
	//    SaveResource(RulesResourceOriginal, _rulesFilePath);
	//}
