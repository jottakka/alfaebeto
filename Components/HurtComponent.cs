using System;
using Alfaebeto.CustomNodes; // Assuming HitBox is here
...
namespace Alfaebeto.Components // Corrected namespace
{
	...
	public sealed partial class HurtComponent : Node
	{
		...
		{
			if (IsHurt || !_isInitialized) return; // Ignore if already hurt or not initialized
		...
		public void OnHurtCooldownTimeout()
		{
			IsHurt = false;
		}
		...
		{
			if (IsHurt || !_isInitialized) return;
