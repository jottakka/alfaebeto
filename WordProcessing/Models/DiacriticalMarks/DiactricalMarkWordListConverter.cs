...
public sealed class DiactricalMarkWordListConverter : JsonConverter<IReadOnlyList<DiactricalMarkWordInfo>>
{
    ...
    {
        List<DiactricalMarkWordInfo> words = new();
    ...
    public override void Write(Utf8JsonWriter writer, IReadOnlyList<DiactricalMarkWordInfo> value, JsonSerializerOptions options)
    {
